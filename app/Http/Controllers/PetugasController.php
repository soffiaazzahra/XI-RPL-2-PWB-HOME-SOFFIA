...
class PetugasController extends Controller
{
    ...
    public function store(StorePetugasRequest $request, Petugas $petugas)
    {
        ...
        return redirect()->route('petugas.index')->with(['Success'=>'Data '.$request['username']. ' Berhasil Disimpan']);
    }
    ...
    public function update(UpdatePetugasRequest $request, Petugas $petugas)
    {
        ...
        return redirect()->route('petugas.index')->with(['Success'=>'Data '.$request['petugas']. 'Berhasil Diedit']);
    }
